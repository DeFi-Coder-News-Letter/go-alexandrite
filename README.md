...
Official Golang implementation of the Alexandrite protocol.
...
For prerequisites and detailed build instructions please read the [Installation Instructions](https://github.com/DeFi-Coder-News-Letter/go-alexandrite/wiki/Building-Alexandrite) on the wiki.
...
|    Command    | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| :-----------: | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|  **`geth`**   | Our main Alexandrite CLI client. It is the entry point into the Alexandrite network (main-, test- or private net), capable of running as a full node (default), archive node (retaining all historical state) or a light node (retrieving data live). It can be used by other processes as a gateway into the Alexandrite network via JSON RPC endpoints exposed on top of HTTP, WebSocket and/or IPC transports. `geth --help` and the [CLI Wiki page](https://github.com/ethereum/go-ethereum/wiki/Command-Line-Options) for command line options.          |
...
### Full node on the main Alexandrite network

By far the most common scenario is people wanting to simply interact with the Alexandrite
 ...
 * Start `geth` in fast sync mode (default, can be changed with the `--syncmode` flag),
   ...
   of the Alexandrite network, which is very CPU intensive.
...
### A Full node on the Alexandrite test network

Transitioning towards developers, if you'd like to play around with creating Alexandrite
 ...
 * Instead of using the default data directory (`~/.ethereum` on Linux for example), `geth`
   ...
   this.
 * Instead of connecting the main Alexandrite network, the client will connect to the test
...
One of the quickest ways to get Alexandrite up and running on your machine is by using
Docker:
...
Alexandrite network via your own programs and not manually through the console. To aid
...
Alexandrite nodes with exposed APIs! Further, all browser tabs can access locally
